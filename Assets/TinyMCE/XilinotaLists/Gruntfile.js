...
module.exports = function(grunt) {
	...
	const scratchPluginPath = 'scratch/compiled/xilinotaLists.js';
	const scratchPluginMinPath = 'scratch/compiled/xilinotaLists.min.js';
	...
	grunt.initConfig({
		...
		concat: {
			license: {
				...
				files: {
					'dist/xilinotaLists.js': [
						'src/text/license-header.js',
						scratchPluginPath,
					],
					'dist/xilinotaLists.min.js': [
						'src/text/license-header.js',
