...
This is a fork of the original [turndown-plugin-gfm](https://github.com/domchristie/turndown-plugin-gfm) for use with [Xilinota](https://github.com/XilinJia/Xilinota). The changes are:
...
```
npm install xilinota-turndown-plugin-gfm
```
...
```js
// For Node.js
var TurndownService = require('@xilinota/turndown')
var turndownPluginGfm = require('@xilinota/turndown-plugin-gfm')
