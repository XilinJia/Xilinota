...
xilinota.plugins.register({
	onStart: async function() {
		await xilinota.commands.register({
			...
			execute: async () => {
				const clipboard = (xilinota as any).clipboard;
		...
		await xilinota.views.toolbarButtons.create('readFromClipboard', 'readFromClipboard', ToolbarButtonLocation.NoteToolbar);
		await xilinota.views.toolbarButtons.create('writeToClipboard', 'writeToClipboard', ToolbarButtonLocation.NoteToolbar);
	},
});
