...
const reducer = require('@xilinota/lib/reducer').default;
...
const DecryptionWorker = require('@xilinota/lib/services/DecryptionWorker').default;
	...
	async processFunctionCommand(cmd) {
		if (cmd === 'activate') {
			...
			if (this.widget('folderList').hasFocus) {
				const item = this.widget('folderList').selectedXilinotaItem;
