const BaseApplication = require('@xilinota/lib/BaseApplication').default;
const { FoldersScreenUtils } = require('@xilinota/lib/folders-screen-utils.js');
const ResourceService = require('@xilinota/lib/services/ResourceService').default;
...
const Cache = require('@xilinota/lib/Cache');
const RevisionService = require('@xilinota/lib/services/RevisionService').default;
