...
import MigrationHandler from '@xilinota/lib/services/synchronizer/MigrationHandler';
...
class Command extends BaseCommand {
	...
	public async doAuth() {
		...
		if (this.syncTargetId_ === 3 || this.syncTargetId_ === 4) {
			...
			this.stdout(_('To allow Xilinota to synchronise with Dropbox, please follow the steps below:'));
