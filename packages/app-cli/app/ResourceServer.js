...
const { findAvailablePort } = require('@xilinota/lib/net-utils');
...
class ResourceServer {
	...
	async start() {
		...
		if (!this.port_) {
			this.logger().error('Could not find available port to start resource server. Please report the error at https://github.com/XilinJia/Xilinota');
			return;
		}
