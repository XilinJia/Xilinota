...
const _ = require('@xilinota/lib/locale')._;
...
class FolderListWidget extends ListWidget {
	...
	render() {
		if (this.updateItems_) {
			this.logger().debug('Rebuilding items...', this.notesParentType, this.selectedXilinotaItemId, this.selectedSearchId);
			const wasSelectedItemId = this.selectedXilinotaItemId;
	...
	get selectedXilinotaItem() {
		const id = this.selectedXilinotaItemId;
		const index = this.itemIndexByKey('id', id);
		return this.itemAt(index);
	}

	updateIndexFromSelectedItemId(itemId = null) {
		if (itemId === null) itemId = this.selectedXilinotaItemId;
