...
import ac.mdiq.xilinota.share.SharePackage;
import ac.mdiq.xilinota.ssl.SslPackage;
import ac.mdiq.xilinota.textinput.TextInputPackage;
...
public class MainApplication extends Application implements ReactApplication {
  ...
  public void onCreate() {
    ...
    // To try to fix the error "Row too big to fit into CursorWindow"
		...
		// https://github.com/XilinJia/Xilinota/issues/1767#issuecomment-515617991
		try {
