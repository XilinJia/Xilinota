...
const PoorManIntervals = require('@xilinota/lib/PoorManIntervals').default;
...
const { basename, fileExtension } = require('@xilinota/lib/path-utils');
...
const { setLocale, defaultLocale, closestSupportedLocale } = require('@xilinota/lib/locale');
