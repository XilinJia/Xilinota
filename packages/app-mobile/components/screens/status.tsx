...
import ReportService, {ReportSection} from '@xilinota/lib/services/ReportService';
...
class StatusScreenComponent extends BaseScreenComponent<Props, State> {
	...
	render() {
		...
		const renderBody = (report: string | any[]) => {
			const baseStyle = {
				paddingLeft: 6,
				paddingRight: 6,
				paddingTop: 2,
...
const StatusScreen = connect((state: AppState) => {
	return {
