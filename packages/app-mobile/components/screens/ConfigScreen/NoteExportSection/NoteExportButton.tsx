...
import { ExportProgressState } from '@xilinota/lib/services/interop/types';
...
const NoteExportButton: FunctionComponent<Props> = props => {
	...
	if (exportStatus === ExportStatus.NotStarted || exportStatus === ExportStatus.Exporting) {
		...
		const descriptionText = _('Share a copy of all notes in a file format that can be imported by Xilinota on a computer.');
