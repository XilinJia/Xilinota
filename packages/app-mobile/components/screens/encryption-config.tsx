...
import { decryptedStatText, enableEncryptionConfirmationMessages, onSavePasswordClick, useInputMasterPassword, useInputPasswords, usePasswordChecker, useStats } from '@xilinota/lib/components/EncryptionConfigScreen/utils';
import { MasterKeyEntity } from '@xilinota/lib/services/e2ee/types';
import { State } from '@xilinota/lib/reducer';
import { SyncInfo } from '@xilinota/lib/services/synchronizer/syncInfoUtils';
import { getDefaultMasterKey, setupAndDisableEncryption, toggleAndSetupEncryption } from '@xilinota/lib/services/e2ee/utils';
			...
			<ScrollView style={styles.container}>
				{
					<View style={{ backgroundColor: theme.warningBackgroundColor, paddingTop: 5, paddingBottom: 5, paddingLeft: 10, paddingRight: 10 }}>
						...
						<TouchableOpacity
							onPress={() => {
								Linking.openURL('https://xilinotaapp.org/e2ee/');
							}}
						>
							<Text>https://xilinotaapp.org/e2ee/</Text>
						</TouchableOpacity>
					</View>
				}
