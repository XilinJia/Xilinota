...
import { DefaultPluginsInfo } from '@xilinota/lib/services/plugins/PluginService';
...
async function start(): Promise<void> {
	...
	const manifestData = await fetch('https://raw.githubusercontent.com/xilinota/plugins/master/manifests.json');
