...
${actual}`);
	...
	test.each([
		...
		[
			'[synchronisation set to Joplin Cloud](https://github.com/XilinJia/Xilinota/blob/dev/readme/apps/sync/xilinota_cloud.md)',
			'[synchronisation set to Joplin Cloud](/help/apps/sync/xilinota_cloud)',
		],
		[
			'The notes can be securely [synchronised](https://github.com/XilinJia/Xilinota/blob/dev/readme/apps/sync/index.md) using [end-to-end encryption](https://github.com/XilinJia/Xilinota/blob/dev/readme/apps/sync/e2ee.md)',
		...
		[
			'[Configuration screen](https://github.com/XilinJia/Xilinota/blob/dev/readme/apps/config_screen.md) [Configuration screen](https://github.com/XilinJia/Xilinota/blob/dev/readme/apps/config_screen.md)',
			'[Configuration screen](/help/apps/config_screen) [Configuration screen](/help/apps/config_screen)',
		],
		[
			'In [command-line mode](https://github.com/XilinJia/Xilinota/blob/dev/readme/apps/terminal.md#command-line-mode), type `import --format md /path/to/file.md`',
