...
export const processUrls = (md: string) => {
	md = md
		.replace(/https:\/\/github.com\/xilinjia\/xilinota\/blob\/dev\/readme\/(.*?)\/index\.md/g, '/help/$1')
		.replace(/https:\/\/github.com\/xilinjia\/xilinota\/blob\/dev\/readme\/(.*?)\.md/g, '/help/$1');
...
[![Donate using PayPal](https://raw.githubusercontent.com/xilinjia/xilinota/dev/Assets/WebsiteAssets/images/badges/Donate-PayPal-green.svg)](https://www.paypal.com/donate/?business=E8JMYD2LQ8MMA&no_recurring=0&item_name=I+rely+on+donations+to+maintain+and+improve+the+Xilinota+open+source+project.+Thank+you+for+your+help+-+it+makes+a+difference%21&currency_code=EUR) [![Sponsor on GitHub](https://raw.githubusercontent.com/xilinjia/xilinota/dev/Assets/WebsiteAssets/images/badges/GitHub-Badge.svg)](https://github.com/sponsors/xilinjia/) [![Become a patron](https://raw.githubusercontent.com/xilinjia/xilinota/dev/Assets/WebsiteAssets/images/badges/Patreon-Badge.svg)](https://www.patreon.com/xilinota) [![Donate using IBAN](https://raw.githubusercontent.com/xilinjia/xilinota/dev/Assets/WebsiteAssets/images/badges/Donate-IBAN.svg)](https://xilinotaapp.org/donate/#donations)
