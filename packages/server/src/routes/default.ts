...
import { localFileFromUrl } from '../utils/xilinotaUtils';
import { homeUrl, loginUrl } from '../utils/urlUtils';
const { mime } = require('@xilinota/lib/mime-utils.js');
...
const pathToFileMap: PathToFileMap = {
	...
	// 'apps/xilinota/css/note.css': 'src/apps/xilinota/css/note.css',
};
