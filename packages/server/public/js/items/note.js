/* global xilinotaNoteViewer */

function addPluginAssets(appBaseUrl, assets) {
	if (!assets) return;

	const pluginAssetsContainer = document.getElementById('xilinota-container-pluginAssetsContainer');
...
docReady(() => {
	addPluginAssets(xilinotaNoteViewer.appBaseUrl, xilinotaNoteViewer.pluginAssets);
