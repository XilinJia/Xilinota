...
describe('markdownUtils', () => {
	...
	it('escape a markdown link', (async () => {
		...
		const testCases = [
			['file:///Users/who put spaces in their username??/.config/xilinota', 'file:///Users/who%20put%20spaces%20in%20their%20username??/.config/xilinota'],
			['file:///Users/(and brackets???)/.config/xilinota', 'file:///Users/%28and%20brackets???%29/.config/xilinota'],
			['file:///Users/thisisfine/.config/xilinota', 'file:///Users/thisisfine/.config/xilinota'],
		];
	...
	it('replace markdown link with description', (async () => {
		...
		const testCases = [
			...
			['No description link to [](https://xilinotaapp.org)', 'No description link to https://xilinotaapp.org'],
		];
