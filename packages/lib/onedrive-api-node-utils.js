...
class OneDriveApiNodeUtils {
	...
	async oauthDance(targetConsole = null) {
		...
		if (!port) throw new Error(_('All potential ports are in use - please report the issue at %s', 'https://github.com/XilinJia/Xilinota'));
		...
		return new Promise((resolve, reject) => {
			...
			targetConsole.log(_('Please open the following URL in your browser to authenticate the application. The application will create a directory in "Apps/Xilinota" and will only read and write files in this directory. It will have no access to any files outside this directory nor to any other personal data. No data will be shared with any third party.'));
			targetConsole.log('');
