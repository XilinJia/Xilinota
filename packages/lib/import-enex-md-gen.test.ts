...
describe('import-enex-md-gen', () => {
	...
	it('should handle invalid mime types', async () => {
		...
		// open the file.
		// https://discourse.xilinotaapp.org/t/importing-a-note-with-a-zip-file/12123?u=laurent
	...
	it('should set resource extension correctly', async () => {
		...
		// file. Fixes https://discourse.xilinotaapp.org/t/import-issue-evernote-enex-containing-musescore-file-mscz/31394/1
