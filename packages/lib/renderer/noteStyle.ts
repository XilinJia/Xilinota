...
export default function(theme: any, options: Options | null = null) {
	...
	const css =
		...
		p, h1, h2, h3, h4, h5, h6, ul, table {
			...
			/*
				...
				Issue: https://github.com/XilinJia/Xilinota/issues/3991
			*/
     ...
     * */
      ...
      -webkit-mask-repeat: no-repeat;
		...
		.jop-tinymce ul.xilinota-checklist .checked,
		...
		.xilinota-editable .xilinota-source {
			display: none;
		}
		...
		*/
		...
		.mce-content-body .xilinota-editable {
		...
		/* Clear the CODE style if the element is within a xilinota-editable block */
		.mce-content-body .xilinota-editable code {
			border: none;
			background: none;
			padding: 0;
			color: inherit;
		...
		/* https://github.com/XilinJia/Xilinota/issues/5740 */
		pre.hljs {
			overflow-x: auto;
		}
