...
const shim = {
	...
	platformSupportsKeyChain: () => {
		...
		// (required by
		// /home/travis/build/laurent22/xilinota/packages/app-cli/node_modules/sharp/build/Release/../../vendor/lib/libpng16.so.16)
		//
		// See: https://travis-ci.org/github/laurent22/xilinota/jobs/686222036
		//
