...
export default class FileApiDriverXilinotaServer {

	private api_: XilinotaServerApi;

	public constructor(api: XilinotaServerApi) {
		this.api_ = api;
	}
	...
	// Transforms a path such as "Apps/Xilinota/file.txt" to a complete a complete
	// API URL path: "api/items/root:/Apps/Xilinota/file.txt:"
