...
export default class Revision extends BaseItem {
	...
	// may contain new lines: https://github.com/XilinJia/Xilinota/issues/6209
		...
		for (const rev of revisions) {
			...
			try {
				...
				if (!keptRev) {
					...
					if (hasEncrypted) throw new XilinotaError('One of the revision to be deleted is encrypted', 'revision_encrypted');
