...
export async function migrateLocalSyncInfo(db: XilinotaDatabase) {
...
export function setMasterKeyEnabled(mkId: string, enabled = true) {
	...
	// https://discourse.xilinotaapp.org/t/syncing-error-with-xilinota-cloud-and-e2ee-master-key-is-not-loaded/20115/5?u=laurent
	//
