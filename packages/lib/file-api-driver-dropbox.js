	...
	async get(path, options) {
		...
		try {
			...
			if (this.hasErrorCode_(error, 'not_found')) {
				...
				throw new XilinotaError('Cannot download because content is restricted by Dropbox', 'rejectedByTarget');
			} else {
				throw error;
			}
		}
	...
	async put(path, content, options = null) {
		...
		try {
			...
			if (this.hasErrorCode_(error, 'restricted_content')) {
				throw new XilinotaError('Cannot upload because content is restricted by Dropbox', 'rejectedByTarget');
			} else {
				throw error;
			}
		}
