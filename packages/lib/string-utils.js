...
exports.scriptType = exports.formatCssSize = exports.camelCaseToDash = exports.nextWhitespaceIndex = exports.substrWithEllipsis = exports.surroundKeywords = exports.escapeHtml = exports.urlDecode = exports.toTitleCase = exports.padLeft = exports.splitCommandBatch = exports.commandArgumentsToString = exports.wrap = exports.escapeFilename = exports.removeDiacritics = exports.replaceRegexDiacritics = exports.pregQuote = void 0;
...
exports.replaceRegexDiacritics = replaceRegexDiacritics;
...
function escapeFilename(s, maxLength = 32) {
    ...
    if (output.toLowerCase() === 'nul')
        output = 'n_l'; // For Windows...
...
function padLeft(str, length, padString) {
    if (!str)
        return '';
