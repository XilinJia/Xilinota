...
export class ApiError extends Error {
	...
	public constructor(message: string, httpCode: number = -1, code: ErrorCode | ErrorOptions = {}) {
		super(message);

		this.httpCode = httpCode === -1 ? 400 : httpCode;
...
export class ErrorMethodNotAllowed extends ApiError {
	...
	public constructor(message = 'Method Not Allowed', options: ErrorOptions = {}) {
...
export class ErrorNotFound extends ApiError {
	...
	public constructor(message = 'Not Found', code: ErrorCode = ErrorCode.Unknown) {
...
export class ErrorForbidden extends ApiError {
	...
	public constructor(message = 'Forbidden', options: ErrorOptions = {}) {
...
export class ErrorBadRequest extends ApiError {
	...
	public constructor(message = 'Bad Request', options: ErrorOptions = {}) {
...
export class ErrorPreconditionFailed extends ApiError {
	...
	public constructor(message = 'Precondition Failed', options: ErrorOptions = {}) {
...
export class ErrorUnprocessableEntity extends ApiError {
	...
	public constructor(message = 'Unprocessable Entity', options: ErrorOptions = {}) {
...
export class ErrorConflict extends ApiError {
	...
	public constructor(message = 'Conflict', code: ErrorCode = ErrorCode.Unknown) {
...
export class ErrorPayloadTooLarge extends ApiError {
	...
	public constructor(message = 'Payload Too Large', options: ErrorOptions = {}) {
...
export class ErrorTooManyRequests extends ApiError {
	...
	public constructor(message: string = '', retryAfterMs = 0) {
		super(!message ? 'Too Many Requests' : message, ErrorTooManyRequests.httpCode);
