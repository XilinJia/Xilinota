...
describe('checkForUpdates', () => {
	...
	it('should extract version info and return the non-arm64 version', async () => {
		const testCases: [any, Platform, Architecture, boolean, Release][] = [
			[
				...
				false,
				{
					downloadUrl: 'https://objects.xilinotausercontent.com/v2.12.4/Xilinota-2.12.4.dmg',
					prerelease: true,
					pageUrl: 'https://github.com/XilinJia/Xilinota/releases/tag/v2.12.4',
					version: '2.12.4',
					notes: '',
				},
			],
			...
			[
				...
				false,
				{
					downloadUrl: 'https://objects.xilinotausercontent.com/v2.12.4/Xilinota-2.12.4-arm64.dmg',
					prerelease: true,
					pageUrl: 'https://github.com/XilinJia/Xilinota/releases/tag/v2.12.4',
					version: '2.12.4',
					notes: '',
			...
			[
				...
				false,
				{
					downloadUrl: 'https://objects.xilinotausercontent.com/v2.12.4/Xilinota-2.12.4.AppImage',
					prerelease: true,
					pageUrl: 'https://github.com/XilinJia/Xilinota/releases/tag/v2.12.4',
					version: '2.12.4',
					notes: '',
			...
			[
				...
				true,
				{
					downloadUrl: 'https://objects.xilinotausercontent.com/v2.12.4/XilinotaPortable.exe',
					prerelease: true,
					pageUrl: 'https://github.com/XilinJia/Xilinota/releases/tag/v2.12.4',
					version: '2.12.4',
					notes: '',
			...
			[
				...
				false,
				{
					downloadUrl: 'https://objects.xilinotausercontent.com/v2.12.4/Xilinota-Setup-2.12.4.exe',
					prerelease: true,
					pageUrl: 'https://github.com/XilinJia/Xilinota/releases/tag/v2.12.4',
					version: '2.12.4',
					notes: '',
	...
	it('macOS should match both .DMG and .dmg extensions', () => {
		// A .DMG may be used to prevent older versions of Xilinota from downloading an incompatible
		// release. Ensure that newer versions of Xilinota can download these releases.
		const releaseDataWithExtension = (extension: string) => {
			const downloadURL = `https://github.com/XilinJia/Xilinota/releases/download/v2.12.4/Xilinota-2.12.4${extension}`;
			const releaseData: GitHubRelease = {
				...
				assets: [
					{
						name: `Xilinota-2.12.4${extension}`,
						browser_download_url: downloadURL,
					},
				],
				html_url: 'https://github.com/XilinJia/Xilinota/releases/tag/v2.12.4',
			};
