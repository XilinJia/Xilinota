...
NEED_COMPILING=0
PLUGIN_PATH=~/src/xilinota/packages/app-cli/tests/support/plugins/simple
...
# Add eg "--profile $HOME/.config/xilinotadev-desktop-1" to test with a different profile