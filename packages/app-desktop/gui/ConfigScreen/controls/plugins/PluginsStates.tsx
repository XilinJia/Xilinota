...
import PluginService, { defaultPluginSetting, Plugins, PluginSetting, PluginSettings } from '@xilinota/lib/services/plugins/PluginService';
...
export default function(props: Props) {
	...
	const onInstall = useCallback(async () => {
		const result = await bridge().showOpenDialog({
			filters: [{ name: 'Xilinota Plugin Archive', extensions: ['jpl'] }],
		});
