	...
	const shareLinkButton_click = useCallback(async () => {
		...
		while (true) {
			try {
				...
				setSharesState('idle');
				alert(XilinotaServerApi.connectionErrorMessage(error));
			}
