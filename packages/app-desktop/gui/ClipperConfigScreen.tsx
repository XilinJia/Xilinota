		...
		return (
			<div>
				<div style={containerStyle}>
					<div>
						<p style={{ ...theme.textStyle, marginTop: 0 }}>{_('Xilinota Web Clipper allows saving web pages and screenshots from your browser to Xilinota.')}</p>
						...
						<div style={stepBoxStyle}>
							...
							<p style={theme.textStyle}>{_('This service allows the browser extension to communicate with Xilinota. When enabling it your firewall may ask you to give permission to Xilinota to listen to a particular port.')}</p>
						...
						<div style={stepBoxStyle}>
							...
							<p style={theme.textStyle}>{_('This authorisation token is only needed to allow third-party applications to access Xilinota.')}</p>
							<div>
