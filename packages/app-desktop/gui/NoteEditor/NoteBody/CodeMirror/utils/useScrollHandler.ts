...
export default function useScrollHandler(editorRef: any, webviewRef: any, onScroll: Function) {
	...
	const editor_scroll = useCallback(() => {
		...
		if (isCodeMirrorReady(cm)) {
			...
			if (!isNaN(editorPercent)) {
				...
				// https://github.com/XilinJia/Xilinota/issues/4797
				if (!ignored) {
	...
	// See https://github.com/XilinJia/Xilinota/issues/5981
...
// https://github.com/XilinJia/Xilinota/pull/5826#issuecomment-986032165
