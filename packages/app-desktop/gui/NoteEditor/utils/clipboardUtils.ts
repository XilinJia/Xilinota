...
function removeImageUrlAttributes(htmlContent: string): string {
	...
	// Related to - https://github.com/XilinJia/Xilinota/issues/4602
...
//
//     <div class="xilinota-editable" contenteditable="false" data-mce-selected="1">
//         <pre class="xilinota-source" data-xilinota-language="javascript" data-xilinota-source-open="```javascript" data-xilinota-source-close="```">var a = 123;</pre>
...
// HtmlToMd, which already supports Xilinota code blocks (it will keep the raw
...
function cleanUpCodeBlocks(html: string): string {
	...
	const sourceElements = element.querySelectorAll('.xilinota-editable .xilinota-source');
...
export function htmlToClipboardData(html: string): ClipboardData {
	...
	// https://github.com/XilinJia/Xilinota/issues/4788
	//
	...
	// https://github.com/XilinJia/Xilinota/issues/5440
	return {
