...
describe('clipboardUtils', () => {
	...
	test('should convert HTML to the right format', () => {
		const testCases = [
			...
			[
				'<div id="rendered-md"><p>aaa</p><div class="xilinota-editable" contenteditable="false"><pre class="xilinota-source" data-xilinota-language="javascript" data-xilinota-source-open="```javascript\n" data-xilinota-source-close="\n```">var a = 123;</pre><pre class="hljs"><code><span class="hljs-keyword">var</span> a = <span class="hljs-number">123</span>;</code></pre></div><ul class="xilinota-checklist"><li class="checked">A checkbox</li></ul></div>',
				'aaa\n\n```javascript\nvar a = 123;\n```\n\n- [x] A checkbox',
				'<div id="rendered-md"><p>aaa</p><div class="xilinota-editable" contenteditable="false"><pre class="hljs"><code><span class="hljs-keyword">var</span> a = <span class="hljs-number">123</span>;</code></pre></div><ul class="xilinota-checklist"><li class="checked">A checkbox</li></ul></div>',
			],
		];
