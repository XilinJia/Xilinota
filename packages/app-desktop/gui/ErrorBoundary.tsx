...
export default class ErrorBoundary extends React.Component<Props, State> {
	...
	public renderMessage() {
		const message = this.props.message || 'Xilinota encountered a fatal error and could not continue.';
		return <p>{message}</p>;
	}
			...
			try {
				...
				return (
					<div style={{ overflow: 'auto', fontFamily: 'sans-serif', padding: '5px 20px' }}>
						<h1>Error</h1>
						{this.renderMessage()}
						<p>To report the error, please copy the *entire content* of this page and post it on Xilinota Forum or GitHub.</p>
