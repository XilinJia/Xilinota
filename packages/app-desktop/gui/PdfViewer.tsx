...
export default function PdfViewer(props: Props) {
	...
	const openExternalViewer = useCallback(async () => {
		await CommandService.instance().execute('openItem', `xilinota://${props.resource.id}`);
	}, [props.resource.id]);
	...
	return (
		<Window theme={theme}>
			<IFrame src="./vendor/lib/@xilinota/pdf-viewer/index.html" x-url={Resource.fullPath(props.resource)}
