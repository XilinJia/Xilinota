...
import { PluginHtmlContents, PluginStates, utils as pluginUtils } from '@xilinota/lib/services/plugins/reducer';
import Sidebar from '../Sidebar/Sidebar';
import UserWebview from '../../services/plugins/UserWebview';
import UserWebviewDialog from '../../services/plugins/UserWebviewDialog';
import { ContainerType } from '@xilinota/lib/services/plugins/WebviewController';
...
import { ShareInvitation } from '@xilinota/lib/services/share/reducer';
import removeKeylessItems from '../ResizableLayout/utils/removeKeylessItems';
import { localSyncInfoFromState } from '@xilinota/lib/services/synchronizer/syncInfoUtils';
import { isCallbackUrl, parseCallbackUrl } from '@xilinota/lib/callbackUrlUtils';
...
class MainScreenComponent extends React.Component<Props, State> {
	...
	private buildLayout(plugins: PluginStates): LayoutItem {
		...
		try {
			...
			// https://github.com/XilinJia/Xilinota/issues/4926
	...
	public renderNotification(theme: any, styles: any) {
		...
		if (this.props.isSafeMode) {
			...
			msg = this.renderNotificationMessage(
				_('The sync target needs to be upgraded before Xilinota can sync. The operation may take a few minutes to complete and the app needs to be restarted. To proceed please click on the link.'),
	...
	private resizableLayout_renderItem(key: string, event: any) {
		...
		// doesn't crash.
		// https://discourse.xilinotaapp.org/t/rearranging-the-pannels-crushed-the-app-and-generated-fatal-error/14373?u=laurent
		if (!key) {
