...
import versionInfo from '@xilinota/lib/versionInfo';
import { ImportModule } from '@xilinota/lib/services/interop/Module';
import InteropServiceHelper from '../InteropServiceHelper';
import { _ } from '@xilinota/lib/locale';
import { isContextMenuItemLocation, MenuItem, MenuItemLocation } from '@xilinota/lib/services/plugins/api/types';
	...
	useEffect(() => {
		...
		function updateMenu() {
			...
			importItems.push({
				...
				click: () => { void bridge().openExternal('https://discourse.xilinotaapp.org/t/importing-notes-from-other-notebook-applications/22425'); },
			});
			...
			const rootMenuFile = {
				...
				// becomes 'Xilinota' and we need a nenu called 'File' later.
				label: shim.isMac() ? '&XilinotaMainMenu' : _('&File'),
				...
				// Issue: https://github.com/XilinJia/Xilinota/issues/934
				submenu: [{
