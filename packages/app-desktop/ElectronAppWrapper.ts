...
export default class ElectronAppWrapper {
	...
	public createWindow() {
		...
		const windowOptions: any = {
			...
			// https://github.com/XilinJia/Xilinota/issues/2031
			//
			// On Linux/GNOME, however, the window doesn't show correctly if show is false initially:
			// https://github.com/XilinJia/Xilinota/issues/8256
		...
		ipcMain.on('pluginMessage', (_event: any, message: PluginMessage) => {
			try {
				...
				// https://github.com/XilinJia/Xilinota/issues/4570
		...
		// https://github.com/XilinJia/Xilinota/issues/2365
