...
const { dirname } = require('@xilinota/tools/gulp/utils');

const rootDir = resolve(__dirname, '../../..');
const nodeModulesDir = resolve(__dirname, '../node_modules');

function stripOffRootDir(path) {
	if (path.startsWith(rootDir)) return path.substring(rootDir.length + 1);
	return path;
}
...
//     '/home/runner/work/xilinota/xilinota/Assets/TinyMCE/langs/ro_RO.js' ->
//     '/home/runner/work/xilinota/xilinota/packages/app-desktop/vendor/lib/tinymce/langs/ro_RO.js']
//
...
async function main() {
	...
	const dirs = [
		...
		// 	dest: `${buildLibDir}/@xilinota/pdf-viewer`,
		// },
	];
	...
	const files = [
		...
		'smalltalk/img/IDR_CLOSE_DIALOG.png',
		{
			...
			dest: `${buildLibDir}/@xilinota/lib/services/plugins/sandboxProxy.js`,
		},
		// {
		// 	src: resolve(__dirname, '../../pdf-viewer/index.html'),
		// 	dest: `${buildLibDir}/@xilinota/pdf-viewer/index.html`,
		// },
	];
