(function(globalObject) {
	...
	const sandboxProxy = require('../../vendor/lib/@xilinota/lib/services/plugins/sandboxProxy.js');
	...
	const target = (path, args) => {
		if (path === 'require' || path === 'plugins.require') { // plugins.require is deprecated
			...
			if (modulePath === 'sqlite3') {
				return require('../../node_modules/@xilinota/lib/node_modules/sqlite3/lib/sqlite3.js');
			}
