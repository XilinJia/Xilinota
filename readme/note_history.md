...
![](https://raw.githubusercontent.com/xilinjia/xilinota/dev/readme/blog/images/20190523-231026_0.png)
...
![](https://raw.githubusercontent.com/xilinjia/xilinota/dev/readme/blog/images/20190523-231026_1.png)

### How to configure the note history feature?

Additional options are available in the `Note History` page of the [Configuration screen](https://github.com/XilinJia/Xilinota/blob/dev/readme/config_screen.md). It is possible to enable/disable the note history feature. It is also possible to specify for how long the history of a note should be kept (by default, for 90 days).
