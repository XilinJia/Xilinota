...
For a more technical description, mostly relevant for development or to review the method being used, please see the [Encryption specification](https://github.com/XilinJia/Xilinota/blob/main/readme/dev/spec/e2ee.md).
